...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.table.setGeometry(QtCore.QRect(10, 270, 231, 261))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(250, 270, 451, 261))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.layoutPlot = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.layoutPlot.setContentsMargins(0, 0, 0, 0)
        self.layoutPlot.setObjectName("layoutPlot")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(parent=Form)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 540, 691, 31))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.layoutToolbar = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
